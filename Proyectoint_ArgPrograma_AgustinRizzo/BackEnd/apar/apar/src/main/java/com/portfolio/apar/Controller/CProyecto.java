...
import com.portfolio.apar.Dto.dtoProyecto;
import com.portfolio.apar.Entity.Proyecto;
import com.portfolio.apar.Security.Controller.Mensaje;
import com.portfolio.apar.Service.SProyecto;
...
public class CProyecto {
   ...
   @GetMapping("/lista")
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyecto dtoproyecto){      
        ...
        Proyecto proyecto = new Proyecto(dtoproyecto.getNombreproy(), dtoproyecto.getUrlproy());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyecto dtoproyecto){
        ...
        proyecto.setUrlproy(dtoproyecto.getUrlproy());
